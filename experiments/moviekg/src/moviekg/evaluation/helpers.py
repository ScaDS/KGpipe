...
def get_reference_config(stage: StageOut, is_ssp: bool) -> ReferenceConfig:
    ...
    return ReferenceConfig(
        ...
        ENTITY_MATCH_THRESHOLD=ENTITY_MATCH_THRESHOLD_MAP.get(stage.root.parent.name, 0.99),
        ...
        source_meta=meta,
        dataset=dataset,
        JSON_EXPECTED_DIR="/home/marvin/project/data/work/json", #TODO cleanup
        JSON_EXPECTED_RELATION_FILE="/home/marvin/project/data/final/film_10k/split_0/sources/json/meta/verified_relation_matches.json" # TODO cleanup
    )
