from kgpipe.common import TaskInput, TaskOutput, KgTask, DataFormat, Data, Registry
...
paris_graph_alignment_task = KgTask(
    name="paris_graph_alignment_task",
...
Registry.add_task(paris_graph_alignment_task.name, paris_graph_alignment_task)
