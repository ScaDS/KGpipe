...
def openie_pipeline_task_function(inputs: TaskInput, outputs: TaskOutput, config: ConfigurationProfile):
    """
    Run the openie pipeline
    """
    pass
...
def openie_pipeline_task(inputs: TaskInput, outputs: TaskOutput, config: ConfigurationProfile):
    """
    Run the openie pipeline
    """
    pass
